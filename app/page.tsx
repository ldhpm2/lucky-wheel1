...
import { 
  Upload, Play, Save, Info, Trash2, UserPlus, Trophy, Download, 
  Sparkles, Loader2, Users, GraduationCap, ClipboardList, 
  Settings, Heart, Code, Star, ChevronRight, RotateCcw, History
} from 'lucide-react';
